...
export default function ModeToggle({ className, variant = "ghost", size = "lg" }: ModeToggleProps) {
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={cn("aspect-square size-10 border-none cursor-pointer hover:bg-transparent ", className)}
    >
